...
namespace Xadrez
{
    public class PartidaDeXadrez
    {
        ...
        public Peca PecaVuneralvelEnPassant { get; private set; }
        public PartidaDeXadrez()
        {
            ...
            this.Turno = 1;
            this.PecaVuneralvelEnPassant = null;
        ...
        public Peca ExecutaMovimento(Posicao origem, Posicao destino)
        {
            ...
            //En Passant
            if(peca is Piao && origem.Coluna != destino.Coluna && pecaCap == null)
            {
                ...
                pecaCap = this.Tabuleiro.RetirarPeca(peaoCapturado);
                this.Capturadas.Add(pecaCap);
            }
            return pecaCap;
        }
        ...
        public void DesfazMovimento(Posicao origem, Posicao destino, Peca pecaCapturada)
        {
            ...
            //En Passant
            if (p is Piao && origem.Coluna != destino.Coluna && pecaCapturada == null)
            {
                ...
                this.Tabuleiro.ColocarPeca(peca, peaoCapturado);
            }
        }
        public void RealizaJogada(Posicao origem, Posicao destino)
        {
            ...
            Peca peca1 = this.Tabuleiro.Peca(destino);
            if(peca1 is Piao && (peca1.Cor == Cor.Branco && destino.Linha == 0) || (peca1.Cor == Cor.Preto && destino.Linha == 7))
            {
                peca1 = this.Tabuleiro.RetirarPeca(destino);
                Pecas.Remove(peca1);
                Rainha rainha = new Rainha(this.Tabuleiro, peca1.Cor);
                this.Tabuleiro.ColocarPeca(rainha, destino);
                Pecas.Add(rainha);
            }
            ...
            MudaJogador();
            //En Passant
            if(peca1 is Piao && (destino.Linha == origem.Linha + 2 || destino.Linha == origem.Linha - 2))
            {
                this.PecaVuneralvelEnPassant = peca1;
            } else
            {
                this.PecaVuneralvelEnPassant = peca1;
            }
        ...
        {
            ColocarNovaPeca('a', 2, new Piao(Tabuleiro, Cor.Branco, this));
            ColocarNovaPeca('b', 2, new Piao(Tabuleiro, Cor.Branco, this));
            ColocarNovaPeca('c', 2, new Piao(Tabuleiro, Cor.Branco, this));
            ColocarNovaPeca('d', 2, new Piao(Tabuleiro, Cor.Branco, this));
            ColocarNovaPeca('e', 2, new Piao(Tabuleiro, Cor.Branco, this));
            ColocarNovaPeca('f', 2, new Piao(Tabuleiro, Cor.Branco, this));
            ColocarNovaPeca('g', 2, new Piao(Tabuleiro, Cor.Branco, this));
            ColocarNovaPeca('h', 2, new Piao(Tabuleiro, Cor.Branco, this));
            ...
            ColocarNovaPeca('a', 7, new Piao(Tabuleiro, Cor.Preto, this));
            ColocarNovaPeca('b', 7, new Piao(Tabuleiro, Cor.Preto, this));
            ColocarNovaPeca('c', 7, new Piao(Tabuleiro, Cor.Preto, this));
            ColocarNovaPeca('d', 7, new Piao(Tabuleiro, Cor.Preto, this));
            ColocarNovaPeca('e', 7, new Piao(Tabuleiro, Cor.Preto, this));
            ColocarNovaPeca('f', 7, new Piao(Tabuleiro, Cor.Preto, this));
            ColocarNovaPeca('g', 7, new Piao(Tabuleiro, Cor.Preto, this));
            ColocarNovaPeca('h', 7, new Piao(Tabuleiro, Cor.Preto, this));
